 ...
 *
 * Disassembly of DSDT-ok.aml, Sun May 24 10:02:34 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00009B05 (39685)
 ...
 */
DefinitionBlock ("DSDT-ok.aml", "DSDT", 1, "_ASUS_", "NoteBook", 0x00000000)
{
    ...
    Name (PDBR, 0x4D)
    Name (MBEC, Zero)
    OperationRegion (GNVS, SystemMemory, 0xBF79CE18, 0x01A8)
            ...
            Device (LPCB)
            {
                ...
                Scope (\_SB.PCI0.LPCB)
                {
                    Device (_SB.MON0)
                    {
                        ...
                        Method (FAN0, 0, Serialized)
                        {
                            If (^^^EC0.ECAV ())
                            {
                                Store (B1B2 (^^^EC0.TAH0, ^^^EC0.TAH1), Local0)
                    ...
                    Device (EC0)
                    {
                        ...
                        OperationRegion (KAID, SystemIO, 0x025D, One)
                        Field (KAID, ByteAcc, NoLock, Preserve)
                        {
                            AEID,   8
                        }

                        OperationRegion (KAIC, SystemIO, 0x025C, One)
                ...
                Scope (EC0)
                {
                    ...
                    Method (SPIN, 2, Serialized)
                    {
                        ...
                        ECCM (Local0, 0xFF, 0xFF, 0xC5)
                    }

                    Method (RPIN, 1, Serialized)
                    {
                        And (Arg0, 0x1F, Local0)
                        Return (ECCM (Local0, 0xFF, 0xFF, 0xC5))
                    }
                    ...
                    {
                        Return (ECCM (0x83, Arg0, 0xFF, 0xB6))
                    }

                    Method (SBRV, 1, Serialized)
                    {
                        ECCM (0x86, Zero, Arg0, 0xB6)
                    }

                    Method (GBRV, 0, Serialized)
                    {
                        Return (ECCM (0x85, Zero, 0xFF, 0xB6))
                    }
                    ...
                    Method (RBEP, 1, NotSerialized)
                    {
                        ...
                        If (LEqual (Acquire (MUEP, 0xFFFF), Zero))
                        {
                            ...
                            {
                                SMBW (WRWD, 0x0B, Zero, 0x02, 0x0635)
                                SMBW (WRWD, 0x0B, Zero, 0x02, 0x0606)
                    ...
                    Method (ST95, 2, Serialized)
                    {
                        If (ECAV ())
                        {
                            If (LEqual (Acquire (MU4T, 0xFFFF), Zero))
                            {
            ...
            Device (PEGR)
            {
                ...
                Device (GFX0)
                {
                    ...
                    Method (ADVD, 0, NotSerialized)
                    {
                        ...
                        {
                            Store (Zero, UPDN)
                            ^^^LPCB.EC0.SPIN (0x12, Zero)
                            GCDD ()
                            Sleep (One)
                            ^^^LPCB.EC0.SPIN (0x12, One)
                            Store (ACTD, SETD)
                        }
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (ASBR, 2, NotSerialized)
        {
            ...
            If (LEqual (BATA, Zero))
            {
                Store (^^PCI0.LPCB.EC0.SMBR (^^PCI0.LPCB.EC0.RDWD, 0x0B, REGS), Local0)
            ...
            If (LEqual (BATA, One))
            {
                Store (^^PCI0.LPCB.EC0.SMBW (^^PCI0.LPCB.EC0.WRWD, 0x0B, REGS, 0x02, BDAT), Local0)
                Store (DerefOf (Index (Local0, Zero)), Local2)
                And (Local2, 0x1F, Local2)
                If (Local2)
                {
            ...
            If (LEqual (BATA, 0x02))
            {
                Store (^^PCI0.LPCB.EC0.SMBR (^^PCI0.LPCB.EC0.RDBL, 0x0B, REGS), Local0)
        ...
        {
            Return (^^PCI0.LPCB.EC0.RPIN (Zero))
        }

        Method (SBTL, 1, Serialized)
        {
            ^^PCI0.LPCB.EC0.SPIN (Zero, Arg0)
        }
        ...
        Method (EC02, 2, NotSerialized)
        {
            ...
            Store (^^PCI0.LPCB.EC0.ECSB (BUSN, PROT, DADD, DREG, DAT0, DAT1), Local0)
    ...
    Scope (\)
    {
        ...
        Method (STBR, 0, Serialized)
        {
            ...
            Store (DerefOf (Index (PWBT, Local0)), Local1)
            \_SB.PCI0.LPCB.EC0.SBRV (Local1)
        }
    }
    ...
    Scope (\)
    {
        ...
        Method (GFAN, 0, Serialized)
        {
            If (\_SB.PCI0.LPCB.EC0.ECAV ())
            {
                Store (B1B2 (\_SB.PCI0.LPCB.EC0.TAH0, \_SB.PCI0.LPCB.EC0.TAH1), Local0)
                And (Local0, 0xFFFF, Local0)
                If (LNotEqual (Local0, Zero))
                {
                    If (LEqual (Local0, 0xFFFF))
        ...
        Method (RFSE, 0, NotSerialized)
        {
            If (\_SB.PCI0.LPCB.EC0.ECAV ())
            {
                Store (\_SB.PCI0.LPCB.EC0.RFOV (Zero), Local1)
        ...
        {
            \_SB.PCI0.LPCB.EC0.SPIN (0x1D, Zero)
            Return (One)
        }
        ...
        {
            \_SB.PCI0.LPCB.EC0.SPIN (0x1D, One)
            Return (One)
        }

        Method (GBTL, 0, Serialized)
        {
            Return (\_SB.PCI0.LPCB.EC0.RPIN (Zero))
        }

        Method (SBTL, 1, Serialized)
        {
            \_SB.PCI0.LPCB.EC0.SPIN (Zero, Arg0)
        }
    }
